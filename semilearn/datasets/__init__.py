...
from semilearn.datasets.cv_datasets import get_cifar, get_eurosat, get_imagenet, get_medmnist, get_semi_aves, get_stl10, get_svhn, get_tinyimagenet, get_adaptiope, get_cifar_os, get_cifar_os_outliers
